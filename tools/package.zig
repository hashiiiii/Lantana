...
pub fn main(init: std.process.Init) !void {
    ...
    if ((args.len != 6 and args.len != 7) or !std.mem.eql(u8, args[1], "render")) return RenderError.InvalidArguments;
    try render(
        arena,
        init.io,
        args[2],
        ...
        args[4],
        args[5],
        if (args.len == 7) args[6] else null,
    );
}
...
pub fn homebrewFormula(arena: Allocator, version: []const u8, hashes: *const ArchiveHashes) ![]const u8 {
    ...
    try output.appendSlice(arena, try std.fmt.allocPrint(arena,
        \\# Generated by Lantana's package tool. Manual changes are overwritten on release.
